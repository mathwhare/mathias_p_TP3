...
/**
 * ´
 * Clase Red:Define las matrices de pesos, los métodos de entrenamiento, de
 * propagación y en general todos los aspectos de campos y funcionalidad de la
 * red neuronal propuesta como trabajo e implementada en Java
 *
 * @author Pablo Borbón
 */
public class Red {
...
// METODOS
    /**
     * Establecer pesos Coloca las matrices de la capa oculta y la capa de
    ...
    /**
     * Inicializar red Inicializa los pesos de la red neuronal pasada como
     * parámetro con un número aleatorio dentro de una distribución de
     * probabilidad Gaussiana con valores entre [-0.5,0.5]
     *
    ...
    /**
     * Obtener Wi Devuelve la matriz de pesos de la capa oculta
     *
    ...
    /**
     * Obtener Wo Devuelve la matriz de pesos de la capa de salida
     *
    ...
    /**
     * Obtener patrones de entrada Devuelve la matriz con los patrones de
    ...
    /**
     * Obtener salidas objetivo devuelve la matriz con los objetivos de
     * entrenamiento
     *
    ...
    /**
     * fNetLog Evalúa la función sigmoidal 1/(1+e^-n) de un valor dado
     *
    ...
    /**
     * f prima de net Evalúa la primera derivada de la función sigmoidal
     * 1/(1+e^-n)
     *
     * @param value valor a evaluar
    ...
    /**
     * F (net) a matriz Evalúa la función sigmoidal a toda una matriz
     *
    ...
    /**
     * Evaluar f'(net) a matriz Evalúa la derivada de la función sigmoidal a
     * toda una matriz
     *
     * @param mat matriz a evaluar
     * @return Matriz con sus elementos evaluados
    ...
    /**
     * Simular Red Neuronal Simula el comportamiento de la red neuronal.
...
//salida de 10x1
    ...
    /**
     * Establecer épocas Establece el número de épocas de entrenamiento han
     * transcurrido en un proceso de entrenamiento tras la condición de salida
     *
    ...
    /**
     * Obtener el número de épocas Devuelve el número de épocas que tuvo una red
     * para alcanzar la condición de salida.
     *
    ...
    /**
     * Entrenar red neuronal Entrena la red neuronal con el siguiente algoritmo:
     * <br>1.Se inicializa a red (valores aleatorios de wi y wo)
     * <br>2.huboError=true;
     * <br>
     * <br>Ciclo1.Mientras (epocas < iteracionesMáximas)&& (huboError==true))
     * <br>Ciclo2 for j=0;j<10;j++ <br> 3.Se presenta el patrón j y se propaga
